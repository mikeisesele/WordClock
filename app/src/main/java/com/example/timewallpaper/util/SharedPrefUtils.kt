...
import com.example.timewallpaper.util.Pref.myPreferences

class SharedPrefUtils {
    private val mSharedPreferences: SharedPreferences = Domain.application.getSharedPreferences(myPreferences, Context.MODE_PRIVATE)
